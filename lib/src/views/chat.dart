...
class ChatView extends StatefulWidget {
  ...
  ChatView({Key key, this.userId, this.userName, this.parentScaffoldKey})
      : super(key: key);
      ...
      title: InkWell(
        onTap: () {
          ...
          Navigator.pushReplacement(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  widget.userId == userRepo.currentUser.value.userId
                      ? MyProfileView()
                      : UsersProfileView(
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Column(
                                                              mainAxisAlignment:
                                                                  MainAxisAlignment
                                                                      .start,
                                                              crossAxisAlignment: (item.fromId !=
                                                                      currentUser
                                                                          .value
                                                                          .userId)
                                                                  ? CrossAxisAlignment
                                    ...
                                    setState(() {
                                      ...
                                      _con.scrollController != null ??
                                          _con.scrollController.animateTo(
                                            _con.scrollController.position
                                                .maxScrollExtent,
