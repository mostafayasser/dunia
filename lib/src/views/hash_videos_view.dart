...
import 'package:Dunia/src/views/user_profile_view.dart';
                                      ...
                                      GestureDetector(
                                        onTap: () async {
                                          videoRepo.homeCon.value
                                              .showFollowingPage.value = false;
                                          videoRepo
                                              .homeCon.value.showFollowingPage
                                              .notifyListeners();
                                          videoRepo.homeCon.value.getVideos();
                                          Navigator.of(context)
                                                      ...
                                                      Container(
                                                          ...
                                                          child: data.videos[i]
                                                              ...
                                                              ? Container(
                                                                  decoration:
                                                                      BoxDecoration(
                                                                    borderRadius: BorderRadius.circular(settingRepo
                                                                        .setting
                                                                        .value
                                                                        .gridBorderRadius),
                                                                    boxShadow: [
