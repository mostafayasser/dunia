                                  ...
                                  child: PopupMenuButton<int>(
                                    ...
                                    onSelected: (int) {
                                      if (int == 0) {
                                        ...
                                        //Delete
                                        print("Delete Video");
                                        _con.showDeleteAlert("Delete Confirmation", "Do you realy want to delete the video", userProfile.userVideos[i].videoId);
                                      }
                                    },
                                    itemBuilder: (context) => [
                                      PopupMenuItem(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(color: settingRepo.setting.value.subHeadingColor, fontSize: 14, fontFamily: 'RockWellStd', fontWeight: FontWeight.w500),
                ),
              ),
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              Container(
                                decoration:
                                    BoxDecoration(border: Border.all(color: settingRepo.setting.value.dividerColor != null ? settingRepo.setting.value.dividerColor : Colors.grey[400], width: 0.4)),
                              ),
                              SizedBox(
                                height: 12,
                              ),
