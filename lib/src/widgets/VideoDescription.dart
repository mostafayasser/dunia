import 'package:Dunia/src/helpers/app_config.dart';
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                        builder: (context) => widget.video.userId ==
                              ...
                              children: [
                                Text(
                                  ...
                                  style: TextStyle(
                                    ...
                                    fontSize: 20,
                                    color:
                                        settingRepo.setting.value.headingColor,
                                  ),
                                ),
                                SizedBox(
                                  width: 5.0,
                                        ...
                                        onTap: () async {
                                          if (userRepo
                                            ...
                                            if (videoRepo.homeCon.value
                                              ...
                                              videoRepo.followingUsersVideoData
                                                  .notifyListeners();
                                            } else {
                                              if (videoRepo
                                            ...
                                            // await videoRepo.homeCon.value.videoController(videoRepo.homeCon.value.swiperIndex)?.pause();
                                            // await videoRepo.homeCon.value.videoController2(videoRepo.homeCon.value.swiperIndex2)?.pause();
                                            videoRepo.isOnHomePage.value =
                                                false;
                                            videoRepo.isOnHomePage
                                                .notifyListeners();
                                            if (!videoRepo.homeCon.value
                                                .showFollowingPage.value) {
                                              videoRepo.homeCon.value
